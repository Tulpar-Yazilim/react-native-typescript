...
import {SchemaMeta} from './types/dataForm';
import {SchemaInputType} from './types/dataForm';

export const formitDefaults = (
  ...
  const keys = defaultValues
    ? Object.keys(defaultValues)
    : (Object.keys(defaultFromShape) as any);
...
export const formitFormData = async ({
  data = {},
  additions = {},
}: FormitFormData) => {
  const formData: any = {};
