...
export const phone: any =
   string
  .meta({ field: SchemaField.InputPhoneNumber })

export const password: any = string
  .label('Parola')
...
export const autoComplete: any = (options: SelectOptions,type: string | number, displayProp?: string ,valueProp?: string) => {
        const _yup = yup as any;
  return _yup?.[type]().nullable().meta({ field: SchemaField.InputAutoComplete, options, displayProp,valueProp })
}
...
export const multipleSelect: any = (options: SelectOptions,type: string | number, displayProp?: string ,valueProp?: string) => {
  return yup?.array().nullable().meta({ field: SchemaField.InputMultipleSelect, options, displayProp,valueProp })
}
