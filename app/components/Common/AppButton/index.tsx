...
const AppButton: FC<Props | any> = props => {
  const {onPress, disabled, type, title, titleColor = COLORS.white, icon, width = '100%', loading, loadingTitle = 'please_wait', style} = props;
  ...
  return (
    <Block pressable style={[styles.container, buttonTypes[type], disabled && styles.disabled, style, {...getStyleShortcuts(props)}]} disabled={disabled} onPress={onPress} width={width}>
      {loading && (
