...
const AppAlert = (props) => {
  ...
  const androidDefaults = {
    ...
    title: {
      ...
      fontFamily: props.android?.title?.fontFamily ?? props.android?.title?.fontFamily,
    ...
    message: {
      ...
      fontFamily: props.android?.message?.fontFamily ?? props.android?.message?.fontFamily,
  ...
  const iOSDefaults = {
    ...
    message: {
      ...
      fontFamily: props.ios?.message?.fontFamily ?? props.ios?.message?.fontFamily,
      ...
      >
        ...
        <View style={styles.alertBox}>
        {
          ...
          <View style={[styles.iOSAlertBox, iOSDefaults.container]}>
            <Text style={[styles.iOSTitle, iOSDefaults.title]}>{props.title || ''}</Text>
          ...
          <View style={[styles.androidAlertBox, androidDefaults.container]}>
            <Text style={[styles.androidTitle, androidDefaults.title]}>{props.title || ''}</Text>
